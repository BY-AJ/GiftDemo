 ...
 * 开服开测界面一样
 */
public class KaiCeDetailsActivity extends BaseActivity {
    ...
    Button btnDownload;
    KaiCeDetailsBean.AppEntity appEntity;
    private String mTitle;
    private String mAppid;
    private ImageView[] mPics;
    private ArrayList<KaiCeDetailsBean.ImgEntity> mImageDatas;
...
//        getDataForService(mDatas.getGid());
    ...
    private void getDataForService(String gid) {
        ...
        private void parase(KaiCeDetailsBean body){
            ...
            mImageDatas= (ArrayList<KaiCeDetailsBean.ImgEntity>) body.getImg();
