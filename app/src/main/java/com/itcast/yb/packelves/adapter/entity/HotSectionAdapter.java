...
public class HotSectionAdapter extends BaseSectionQuickAdapter<MyHotSectionEntity,BaseViewHolder>{
    /**
     ...
     */
    public HotSectionAdapter(int layoutResId, int sectionHeadResId, List<MyHotSectionEntity> data) {
